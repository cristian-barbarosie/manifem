...
{	// begin with the usual two-dimensional space
	...
	Function::Action g1 ( tag::transforms, ab, tag::into, (alpha+2.*pi) && beta ),
	...
	Mesh seg_horiz ( tag::segment, A.reverse(), A, tag::divided_in, 40, tag::spin, g1 ),
	     seg_vert  ( tag::segment, A.reverse(), A, tag::divided_in, 20, tag::spin, g2 );

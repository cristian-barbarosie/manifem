...
{	Manifold RR3 ( tag::Euclid, tag::of_dim, 3 );
	...
	Mesh circle_1_rev ( tag::progressive, tag::start_at, start_1, tag::towards, { 0., 0., -1. },
	                tag::desired_length, seg_size                                          );
	...
	Mesh circle_2 ( tag::progressive, tag::start_at, start_2, tag::towards, { 0., 1., 0. },
	                tag::desired_length, seg_size                                          );
	Mesh circle_2_rev ( tag::progressive, tag::start_at, start_2, tag::towards, { 0., -1., 0. },
	                tag::desired_length, seg_size                                          );
	...
	Mesh two_circles ( tag::join, circle_1 .reverse(), circle_2 .reverse() );
	std::cout << "main line 55" << std::endl;
  Mesh torus_2 ( tag::progressive, tag::boundary, two_circles,
	               tag::start_at, start_2, tag::towards, { 0.2, 0., 1. },
	               tag::desired_length, seg_size                         );

	// Mesh two_tori ( tag::join, torus_1, torus_2 );

	std::cout << "main line 62" << std::endl;
	// two_circles .export_to_file ( tag::msh, "torus_1.msh");
	// torus_2 .export_to_file ( tag::msh, "torus_2.msh");

...
{	Manifold RR3 ( tag::Euclid, tag::of_dim, 3 );
	...
	Mesh B2C2C3B3 ( tag::quadrangle, B2C2, C2C3, B3C3 .reverse(), B2B3 .reverse(),
                  tag::with_triangles                                           );
	Mesh B3C3C4B4 ( tag::quadrangle, B3C3, C3C4, B4C4 .reverse(), B3B4 .reverse(),
                  tag::with_triangles                                           );
	Mesh B4C4C5B5 ( tag::quadrangle, B4C4, C4C5, B5C5 .reverse(), B4B5 .reverse(),
                  tag::with_triangles                                           );
	Mesh B5C5C6B6 ( tag::quadrangle, B5C5, C5C6, B6C6 .reverse(), B5B6 .reverse(),
                  tag::with_triangles                                           );
	Mesh B6C6C7B7 ( tag::quadrangle, B6C6, C6C7, B7C7 .reverse(), B6B7 .reverse(),
                  tag::with_triangles                                           );
	Mesh B7C7C8B8 ( tag::quadrangle, B7C7, C7C8, B8C8 .reverse(), B7B8 .reverse(),
                  tag::with_triangles                                           );
	Mesh B8C8C1B1 ( tag::quadrangle, B8C8, C8C1, B1C1 .reverse(), B8B1 .reverse(),
                  tag::with_triangles                                           );

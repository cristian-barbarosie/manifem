...
// square periodicity, circular hole, triangular elements, formulation in stress
  ...
  //                 tag::over_region, -2.1 < x < 4.3, -3.6 < y < 2.1 );
	...
	{	Cell small_tri = *it;
		...
		{	Cell V = * it_V;   // the test function is psi_V
			...
			Manifold::Action winding_V_W = 0; // g de V para W
			while ( true )
	...
	square .export_to_file ( tag::msh, "cell-elast-stress-cell-sq.msh", numbering );

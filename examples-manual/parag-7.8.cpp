...
{	// begin with the usual two-dimensional space
	...
	Mesh BA1 ( tag::segment, B .reverse(), A, tag::divided_in, 5, tag::winding, g1 );
	Mesh BA2 ( tag::segment, B .reverse(), A, tag::divided_in, 10, tag::winding, g2 );
	Mesh AB2 ( tag::segment, A .reverse(), B, tag::divided_in, 10, tag::winding, g2 - g1 );

	Mesh sq1 ( tag::rectangle, AB, BA2, BA1.reverse(), AB2 .reverse(), tag::winding );
	Mesh sq2 ( tag::rectangle, BA2 .reverse(), BA1, AB2, AB .reverse(), tag::winding );

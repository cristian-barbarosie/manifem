...
( Cell::Positive::Vertex * P,
  double s, Cell::Positive::Vertex * A,
  double t, Cell::Positive::Vertex * B,
  const tag::Spin &, const Function::CompositionOfActions & exp_AB,
  double u, Cell::Positive::Vertex * C,
  const tag::Spin &, const Function::CompositionOfActions & exp_AC,
...
( Cell::Positive::Vertex * P,
  ...
  const tag::Spin &, const Function::CompositionOfActions & exp_AC,
  double v, Cell::Positive::Vertex * D,
  const tag::Spin &, const Function::CompositionOfActions & exp_AD,
  double w, Cell::Positive::Vertex * E,
  const tag::Spin &, const Function::CompositionOfActions & exp_AE,

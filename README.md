...
In its current version, release 21.04, maniFEM works well for mesh generation. 
...
To learn maniFEM, you should read the [manual](http://manifem.rd.ciencias.ulisboa.pt/manual-manifem.pdf) (version 21.04).
